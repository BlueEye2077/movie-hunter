...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  idle,TResult Function()?  loading,TResult Function( T data)?  success,TResult Function( NetworkExceptions networkException)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Idle() when idle != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  idle,required TResult Function()  loading,required TResult Function( T data)  success,required TResult Function( NetworkExceptions networkException)  error,}) {final _that = this;
switch (_that) {
case Idle():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  idle,TResult? Function()?  loading,TResult? Function( T data)?  success,TResult? Function( NetworkExceptions networkException)?  error,}) {final _that = this;
switch (_that) {
case Idle() when idle != null:
return idle();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Idle<T> implements RequestsState<T> {
  const Idle();
...
class Error<T> implements RequestsState<T> {
...
@override
String toString() {
  return 'RequestsState<$T>.error(networkException: $networkException)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $RequestsStateCopyWith<T, $Res> {
